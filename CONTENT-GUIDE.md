...
**Case-set change 2026-07-13.** The Selected work section was rebuilt: case-more, case-bandcamp and case-firezone were retired (pages, cards and images removed), and seven cases were added — case-nextgen (Tino Taonga), case-peniel, case-littlethings, case-butterfly, case-wcn, case-bearers, case-rhythms — each with its own `work-*.jpg`/`.webp` card art and live-site link. The homepage grid now holds 8 cards and its section note reads "Web, app and audio, one desk." kris.html's Selected history gained four rows (Little Things 2026, Peniel 2025–now, Rhythms 2023–24, Bearers 2016). The per-block copy inventory below still describes the OLD four-case set — rows for the new pages haven't been inventoried yet; read the new files directly until a future pass adds them.
